1. Decentralized NFT markeplace:
    1. `listItem`: List NFTs on the markeplace
    2. `buyItem`: Buy the NFTs
    3. `cancelItem`: cancel the listing
    4. `updateListing`: update Price
    5. `withdrawProceeds`: withdraw paymanet for my bought NFTs
...
<br/>
<p align="center">
<img src="./img/code_coverage.png" width="500" alt="Hardhat NextJS Marketplace">
</a>
</p>
<br/>
...
```
git clone https://github.com/SaikrishnaReddy1919/hardhat-nft-marketplace
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://github.com/SaikrishnaReddy1919/hardhat-nft-marketplace)
